...
public class Config extends Vigilant {
    ...
    public Config() {
        super(CONFIG_FILE, "CoinSkids Configuration", new JVMAnnotationPropertyCollector(), new CustomSorting());
        initialize();
    }
    ...
    public static void patreon() {
        UDesktop.browse(URI.create("https://discord.gg/F5zpbJnHsh"));
    }
    ...
    public static void github() {
        UDesktop.browse(URI.create("https://github.com/FakePlosive/CoinSkids"));
    }
