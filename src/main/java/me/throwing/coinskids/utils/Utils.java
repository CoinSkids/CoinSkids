package me.throwing.coinskids.utils;
...
import me.throwing.coinskids.objects.BestSellingMethod;
...
public class Utils {
    ...
    public static void sendMessageWithPrefix(String message) {
        UChat.chat(EnumChatFormatting.GOLD + ("[CoinSkids] ") + message.replaceAll("&", "§"));
    }

    public static void sendMessageWithPrefix(String message, ClickEvent clickEvent) {
        UTextComponent result = new UTextComponent(EnumChatFormatting.GOLD + ("[CoinSkids] ") + message.replaceAll("&", "§"));
